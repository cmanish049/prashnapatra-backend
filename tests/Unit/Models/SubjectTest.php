...
test('subject can be created with factory', function () {
...
test('subject has required attributes', function () {
...
test('subject belongs to university', function () {
    $subject = Subject::factory()->create();
...
test('subject belongs to program', function () {
    $subject = Subject::factory()->create();
...
test('subject can access its university', function () {
...
test('subject can access its program', function () {
    $university = University::factory()->create();
